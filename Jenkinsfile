...
pipeline {
    ...
    stages {
        ...
        stage('Code fetching') {
            steps {
                     checkout([$class: 'GitSCM', branches: [[name: 'add_jenkinsfile_2']],  extensions: [[$class: 'CleanCheckout']], userRemoteConfigs: [[url: 'https://github.com/indigo-dc/spring-social-oidc.git']]])
            }
        }
